...
![](vx_images/130694454367542.png){: width="300px"}

![](vx_images/279975677456151.png){: width="300px"}

### 2.新建下级Node
(更推荐方式：鼠标左键选中一个node，直接Shift+回车，新的同级Node自动创建)
选中某个Node，鼠标右键点击下图中的选项然后回车

![](vx_images/562996449244555.png){: width="300px"}

![](vx_images/47317658888086.png){: width="300px"}

### 3.新建一个Tab界面
选中某个已经存在的NodeTab，鼠标右键点击下图中的选项然后回车

![](vx_images/271396090896079.png){: width="300px"}

![](vx_images/361886060050042.png){: width="300px"}
...
![](vx_images/178956029552147.png){: width="300px"}
...
![](vx_images/546056856835986.png){: width="300px"}

### 6.本Node内查找
（快捷键 Ctrl+F 可以直接调出 ）

![](vx_images/401213962630430.png){: width="400px"}

![](vx_images/583156490002471.png){: width="400px"}
...
![](vx_images/207258290124885.png){: width="200px"}

### 8.切换当前打开的knt工作文件
如下操作可以进入文件已打开列表，切换knt

![](vx_images/251987974058742.png){: width="200px"}

![](vx_images/324948783893112.png){: width="400px"}

### 9.导入/并入另一个Knt文件

![](vx_images/538216731092733.png){: width="200px"}

![](vx_images/578117280979143.png){: width="400px"}

![](vx_images/167467415034556.png){: width="400px"}

![](vx_images/326274247818063.png){: width="400px"}  

![](vx_images/398334025856014.png){: width="400px"}

### 10.修改图片存储模式为外部存储
(注意：如果改为外部存储图片模式，对于加密文件，外部图片不会跟随文件加密)

![](vx_images/308910850618085.png){: width="400px"}

![](vx_images/521253753601762.png){: width="400px"}
...
![](vx_images/401233996323484.png){: width="300px"}

过滤后的效果：(仅对当前 Folder生效 )

![](vx_images/568851578989038.png){: width="300px"}

![](vx_images/107530528520861.png){: width="300px"}

`禁用按钮---如果直接点击，则禁用。如果是 ctrl+点击，则会清除这个过滤效果`。

禁用过滤后的效果 (仅对当前 Folder生效 )

![](vx_images/303234568677183.png){: width="300px"}
...
![](vx_images/430880827602340.png){: width="400px"}

插入要链接的 KeyNote位置 --- `Shift+F6`
	效果（ 使用 Ctrl + 鼠标左键点击 即可跳转，Alt + ⬅ 即可回退位置）：

![](vx_images/16354729634189.png){: width="400px"}


### 切换当前knt工作文件
快捷键F12，即呈现当前打开的文件列表。

![](vx_images/390903943830075.png){: width="400px"}
...
![](vx_images/311101251342115.png){: width="100px"}
		
第二部 快捷键 Ctrl  +

![](vx_images/400673701493978.png){: width="150"}
...
![](vx_images/266743927524694.png){: width="400px"}
 
如果要设置 文件进行 加密，则按下图配置

![](vx_images/360251644665883.png){: width="400px"}

设置密码口令，这里我写的是一个简单密码，请勿模仿（这里完成以后，`Ctrl+S`保存当前KeyNote文件即加密生效）

![](vx_images/584051879375303.png){: width="400px"}

![](vx_images/105031392221929.png){: width="400px"}

再次打开就要密码了。

![](vx_images/186901133759252.png){: width="400px"}
